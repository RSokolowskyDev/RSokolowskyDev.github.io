      ...
      <div className="grid grid-cols-1 gap-10 w-full max-w-6xl mx-auto">
            ...
            <div className="theme-card flex flex-col gap-4 bg-white/60 dark:bg-zinc-900/40 backdrop-blur-[3px] rounded-2xl p-8 border-[3px] border-[#F2360C]/5">
              ...
              <p className="text-zinc-700 dark:text-zinc-200 text-sm leading-relaxed tracking-[0.2em] uppercase">
                Software Engineering student at Ensign College and practicing <span className="text-[#F2360C] text-lg font-bold">AI Solutions Engineer</span> with a track record of bridging technical depth and commercial strategy. Known for combining <span className="text-[#F27329] text-lg font-bold">Python automation</span>, LLM integration, and data-driven decision-making to create compounding business value. Equally comfortable leading cross-functional teams and writing production code.
              </p>
            </div>
          ...
          <div className="theme-card flex flex-col gap-4 bg-white/60 dark:bg-zinc-900/40 backdrop-blur-[3px] rounded-2xl p-8 border-[3px] border-[#F2360C]/5">
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-zinc-700 dark:text-zinc-300 text-2xl font-bold tracking-[0.2em] uppercase">
                 AI Solutions Engineer Intern <span className="text-[#F27329]">|</span> Interior Solutions
                </h2>
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-zinc-700 dark:text-zinc-300 text-2xl font-bold tracking-[0.2em] uppercase">
                 Member Service Representative II <span className="text-[#F27329]">|</span> UCCU
                </h2>
                <p className="text-zinc-600 dark:text-zinc-200 text-xs leading-relaxed tracking-[0.2em] uppercase max-w-2xl">
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-zinc-700 dark:text-zinc-300 text-2xl font-bold tracking-[0.2em] uppercase">
                 Spanish Ads & AI Optimization Manager <span className="text-[#F27329]">|</span> THE CHURCH OF JESUS CHRIST OF LATTER-DAY SAINTS
                </h2>
                <p className="text-zinc-600 dark:text-zinc-200 text-xs leading-relaxed tracking-[0.2em] uppercase max-w-2xl">
                  <span className="text-[#F2360C] font-bold text-4xl leading-[0] relative top-[8px]">·</span>
